export const homeFAQ = [
  {
    ...
    content: (
      <>
        <p>
          Agave, in a few words, is Aave on xDai. For more information, please refer to these
          articles:
        </p>
        <ul>
          <li>
            <a
              href="https://forum.1hive.org/t/ag-token-launch/2108"
              rel="noreferrer"
              target="_blank"
            >
              AGVE Token Launch
          ...
          <li>
            <a
              href="https://forum.1hive.org/t/announcing-agaave-aave-on-xdai/1792"
              rel="noreferrer"
              target="_blank"
            >
              Announcing Agave, Aave on xDai
            </a>
          </li>
        </ul>
        <p>
  ...
  },
  {
    ...
    content: (
      <p>
        ...
        is <code>0x3a97704a1b25F08aa230ae53B352e2e72ef52843</code>
      </p>
    ),
  },
  {
    title: 'What is the total supply of $AGVE?',
    content: (
      <ul>
        <li>
  ...
  {
    title: 'Where can I see a chart of $AGVE?',
    content: (
      <ul>
        <li>
          <a
            href="https://info.honeyswap.org/token/0x3a97704a1b25f08aa230ae53b352e2e72ef52843#/"
            rel="noreferrer"
            target="_blank"
          >
            Here
          </a>{' '}
          you can see the chart for <b>$AGVE</b> from the Honeyswap Analytics page.
        </li>
        <li>
    ...
    content: (
      <>
        ...
        <ul>
          ...
          <li>
            Twitter:{' '}
            <a href="https://twitter.com/Agave_lending" rel="noreferrer" target="_blank">
              https://twitter.com/Agave_lending
            </a>
          </li>
          <li>
            Medium:{' '}
            <a href="https://agavefinance.medium.com" rel="noreferrer" target="_blank">
              https://agavefinance.medium.com
            </a>
          </li>
          <li>
            Reddit:{' '}
